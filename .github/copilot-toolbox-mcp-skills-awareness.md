...
_Generated: 2026-06-30T18:01:25.864Z_
...
Workspace `mcp.json` _(folder: Nexus mirror)_

- **c:\Users\DELL\Desktop\Self study\Coding\general apps and webs\Nexus mirror\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\DELL\AppData\Roaming\Code\User\mcp.json** — _File missing_
